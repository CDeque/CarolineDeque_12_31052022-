  ...
  return (
    <NavContainer>
      <SportCategoriesContainer>
        <NavLink to="#">
          <IconContainer>
            <SportIcons src={MediationIcon} alt="meditation-icon" />
          </IconContainer>
        </NavLink>
        <NavLink to="#">
          <IconContainer>
            <SportIcons src={SwimmingIcon} alt="swimming-icon" />
          </IconContainer>
        </NavLink>
        <NavLink to="#">
          <IconContainer>
            <SportIcons src={ByciclesIcon} alt="bicycle-icon" />
          </IconContainer>
        </NavLink>
        <NavLink to="#">
          <IconContainer>
            <SportIcons src={WeightIcon} alt="weight-icon" />
          </IconContainer>
        </NavLink>
      </SportCategoriesContainer>
      <CopyrightContainer>
